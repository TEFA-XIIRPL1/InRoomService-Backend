...
async function getAll(req, res) {
  try {
    ...
    successResponse(
      res,
      'Product requests retrieved successfully',
      productReqs,
      200,
    );
  } catch (error) {
    ...
    errorResponse(
      res,
      'An error occurred while fetching product requests',
      '',
      500,
    );
  }
...
async function getProductReqById(req, res) {
  ...
  try {
    ...
    errorResponse(
      res,
      'An error occurred while fetching product request data',
      '',
      500,
    );
  }
...
async function update(req, res) {
  ...
  try {
    ...
    errorResponse(
      res,
      'An error occurred while updating the product request',
      '',
      500,
    );
  }
...
async function remove(req, res) {
  ...
  try {
    ...
    successResponse(
      res,
      'Product request has been deleted successfully',
      {},
      200,
    );
  } catch (error) {
    ...
    errorResponse(
      res,
      'An error occurred while deleting the product request',
      '',
      500,
    );
  }
